...
exports.ItineraryViewService = void 0;
const db_js_1 = require("../config/db.js");
const AppError_js_1 = require("../utils/AppError.js");
class ItineraryViewService {
    ...
    static async getDayWiseView(userId, tripId) {
        const trip = await this.getTripAndVerifyOwner(userId, tripId);
        const sections = await db_js_1.prisma.itinerarySection.findMany({
            where: { tripId },
    ...
    static async getTimelineView(userId, tripId) {
        const trip = await this.getTripAndVerifyOwner(userId, tripId);
        const sections = await db_js_1.prisma.itinerarySection.findMany({
            where: { tripId },
            include: {
    ...
    static async getSummaryView(userId, tripId) {
        const trip = await this.getTripAndVerifyOwner(userId, tripId);
        const sections = await db_js_1.prisma.itinerarySection.findMany({
            where: { tripId },
            include: {
...
exports.ItineraryViewService = ItineraryViewService;
